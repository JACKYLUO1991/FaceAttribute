...
#                 image, pnet, scale=s, threshold=thresholds[0])
...
"""
RetinaFace detection method
"""
import numpy as np
from retinaface import retinaface


def detect_faces(image, scales=[224, 384]):
    # pipline of landmarks and facial box detection
    assert isinstance(scales, list)
    detector = retinaface.RetinaFace("./retinaface/model/mnet.25", 0, -1, 'net3')
